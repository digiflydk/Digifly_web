...
import type { CmsLink } from "@/lib/schemas";
...
export default function LinkPicker({ namePrefix, pages }: LinkPickerProps) {
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <Select onValueChange={handleTypeChange} value={field.value ?? 'internal'}>
              <FormControl><SelectTrigger><SelectValue placeholder="Select a link type" /></SelectTrigger></FormControl>
              <SelectContent>
